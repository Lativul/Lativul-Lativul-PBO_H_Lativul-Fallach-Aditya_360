...
public class LoginSystem {
    ...
    public static void main(String[] args) {
        ...
        userList.add(new Mahasiswa("Lativul Fallach Aditya", "202410370110360"));
        userList.add(new Admin("Admin360", "password360", "Lativul Fallach Aditya", "20241037011360", userList));
